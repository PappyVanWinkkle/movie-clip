...
import { GET_TV_TRAILER } from "./actions";
...
// Gets a trailer for a specific TV Show
export function fetchTVTrailerActionCreator(id) {
  const request = axios.get(`${baseURL}/tv/${id}/videos`, {
    params: { api_key: API_KEY }
  });
  return dispatch => {
    request.then(res => {
